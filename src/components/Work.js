...
const ProjectItem = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* Title */}
        <h3 className='font-gilroy overflow-hidden text-2xl font-medium leading-[100%]'>
      ...
      >
        {project?.media && (
          <Image
            ...
            alt='bride and groom'
            fill={true}
            className='object-cover mix-blend-luminosity transition-transform duration-700 ease-out hover:scale-105'
