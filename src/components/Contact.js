...
export default function Contact({ data, timeline }) {
  ...
  return (
    <Box
      timeline={timeline}
      className='-translate-y-full scale-0 bg-secondary text-background opacity-0'
    ...
    >
      <div className='size-full'>
        ...
        >
          ...
          <h2
            className='contact-heading font-gilroy pb-2 text-[3.2rem] font-medium leading-[100%]'
